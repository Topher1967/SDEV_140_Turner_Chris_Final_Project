...
""" working GUI of a calculator, in my calculator GUI I used an if else statement
to ensure the user started at 0 and then deleted the 0 to accumulate the numbers selected,
also included a working clear button to clear all the numbers"""
...
class Ui_CalcWindow(object):
    ...
    def press_it(self,pressed):
        if pressed == "C":
            ...
            #Check to see if it starts with 0 and delete the 0
